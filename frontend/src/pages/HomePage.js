...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Tours Section */}
      <div id="tours" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">
            {i18n.t('home.featured_tours')}
          </h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Descubra experiências únicas pelos tesouros escondidos de Portugal
          </p>
        </div>
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <span className="text-gray-500 text-sm ml-1">/ pessoa</span>
                    </div>
                    <Link
                      to={`/tour/${tour.id}`}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            ...
            <p className="text-xl mb-8">
              Junte-se a nós e descubra os sabores e histórias de Portugal
            </p>
            <Link
              to="/contact"
              className="inline-block bg-white text-indigo-600 px-8 py-4 rounded-lg font-semibold text-lg hover:bg-gray-100 transition-colors duration-300"
